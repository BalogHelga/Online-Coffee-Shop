...
import com.proiect.Coffee_Shop.service.ProductServiceImpl;
...
@RestController
@RequestMapping(value="/api/product", produces="application/json", method={RequestMethod.GET, RequestMethod.PUT, RequestMethod.POST})
@CrossOrigin
